...
namespace UGoap.Unity.Actions
{
    ...
    public class SetBestDestinationAction : GoapAction
    {
        ...
        public override bool ProceduralValidate(GoapState goapState, GoapActionInfo actionInfo, IGoapAgent agent)
        {
        ...
        public override void ProceduralExecute(ref GoapState goapState, IGoapAgent agent)
        {
